...
public class OPPBuilder<TUserState, TTerm, TAfterString> {
    ...
    private readonly OperatorPrecedenceParser<TTerm, TAfterString, TUserState> lowOpp = new();
    private readonly OperatorPrecedenceParser<TTerm, TAfterString, TUserState> highOpp = new();

    private readonly Operators<TUserState, TTerm, TAfterString> operators = new();
